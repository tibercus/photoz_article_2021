...
\begin{figure*}
    \centering
    \includegraphics[width=0.9\linewidth]{images/scatterplot-cv2-gal-a.png}
...
% \begin{figure*}
%     \centering
%     \includegraphics[width=0.9\linewidth]{images/scatterplot-cv2-qso-a.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.9\linewidth]{images/scatterplot-cv2-a.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.9\linewidth]{images/scatterplot-dr16q-a.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.9\linewidth]{images/scatterplot-s82x-a.png}
    \caption{Scatterplots of predictions on Stripe82X X-ray test sample of three models (from left to right) -- \ref{model:spdw}, \ref{model:pw}, \ref{model:dw}. The abscissa axis shows the spectral redshift value, and the ordinate axis shows the photometric redshift prediction. The color and size of dots show the prediction reliability zConf \eqref{eq:zconf}. The gray area around the diagonal is the area of predictions that are not catastrophic emissions according to metric \eqref{eq:n015}.}
    \label{fig:scatter-s82x}
\end{figure*}

\subsection{Зависимость точности от оптической величины}\label{ssec:accuracy-as-fzmag}
...
\subsection{Зависимость точность и полноты прогнозов от наблююдаемых и целевой величин}\label{ssec:precision-and-completeness}
...
\subsection{Сравнение с другими моделями}\label{ssec:sota-comp}
...
\begin{table*}
	\begin{tabular}{lrrrrrrrrr}
            \hline
            {} & \multicolumn{3}{l}{$FSoft \geq 3e-15$ (2665 objects)} & \multicolumn{3}{l}{$FSoft \geq 1e-14$ (1505 objects)} & \multicolumn{3}{l}{$FSoft \geq 4e-14$ (242 objects)} \\
            {} &                         Precision & Completeness & $N_{preds}$ &                         Precision & Completeness & $N_{preds}$ &                        Precision & Completeness & $N_{preds}$ \\
            Model &                                   &              &             &                                   &              &             &                                  &              &             \\
            \hline
            PW    &                             0.935 &        0.722 &        2194 &                             0.937 &        0.770 &        1284 &                            0.944 &        0.876 &         210 \\
            PDW   &                             0.944 &        0.758 &        2231 &                             0.948 &        0.805 &        1291 &                            0.953 &        0.876 &         210 \\
            DW    &                             0.883 &        0.667 &        2651 &                             0.889 &        0.703 &        1498 &                            0.882 &        0.720 &         239 \\
            SPW   &                             0.963 &        0.790 &        2173 &                             0.970 &        0.843 &        1274 &                            0.964 &        0.904 &         208 \\
            SPDW  &                             0.969 &        0.801 &        2208 &                             0.975 &        0.846 &        1280 &                            0.974 &        0.918 &         208 \\
            \hline
            \end{tabular}
